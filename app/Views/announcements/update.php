...
<body>
                    ...
                    <div class="row">
                        ...
                        <div class="content-header">
                            <div class="container-fluid">
                                <div class="row mb-2">
                                    <div class="col-sm-6">
                                        <h1 class="m-0">Pengajuan Pengumuman</h1>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="container-fluid">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <form action="<?= base_url('/update_announcement/update/' . $announcement['id']); ?>" method="POST" enctype="multipart/form-data">
                                                    <?= csrf_field(); ?>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" value="<?= isset($form_data['title']) ? $form_data['title'] : $announcement['title'] ?>" class="form-control <?= (isset($errors['title']) ? 'is-invalid' : ''); ?>" name="title" id="title" autofocus />
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <small class="form-text text-muted">
                                                            File saat ini:
                                                            <a href="<?= base_url('/'); ?>assets/docs/<?= isset($document['file_path']) ? $document['file_path'] : '' ?>" target="_blank"><?= isset($document['title']) ? $document['title'] : '' ?></a>
                                                        </small>
                                                        <div class="invalid-feedback">
                                                            <?= isset($errors['document']) ? $errors['document'] : '' ?>
                                                        </div>
                                                    </div>
                                                    <div class="mb-3" id="ubahLampiran">
                                                        <label class="form-label">Dokumen Lampiran</label>
                                                        <?php if (count($lampiran) > 0) : ?>
                                                            <small class="form-text text-muted">
                                                                Lampiran saat ini:
                                                            </small>
                                                            <?php foreach ($lampiran as $dokumen) : ?>
                                                                <div class="input-group mb-3">
                                                                    <small class="form-text text-muted">
                                                                        <?php if ($announcement['category'] === 'CPNS') : ?>
                                                                            <a href="<?= base_url('/'); ?>assets/docs/<?= $dokumen['file_path'] ?>" target="_blank"><?= $dokumen['title'] ?></a>
                                                                        <?php else : ?>
                                                                            <a href="<?= base_url('/'); ?>assets/docs/pppk/<?= $dokumen['file_path'] ?>" target="_blank"><?= $dokumen['title'] ?></a>
                                                                        <?php endif; ?>
                                                                    </small>
                                                                </div>
                                                            <?php endforeach; ?>
                                                    ...
                                                    <button type="button" id="updateLampiran" class="btn btn-primary mb-3">Ubah Lampiran</button>
                                                    <!-- <div id="updateLampiran">

                                                    </div> -->
                                                    <div class="mb-3">
                                                        <label for="content" class="form-label">Deskripsi</label>
                                                        <textarea class="form-control" id="content" name="content"><?= isset($form_data['content']) ? $form_data['content'] : $announcement['content'] ?></textarea>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="publish_date" class="form-label">Tanggal Upload</label>
                                                        <input type="date" value="<?= isset($form_data['publish_date']) ? $form_data['publish_date'] : $announcement['publish_date'] ?>" class="form-control" name="publish_date" id="publish_date" />
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="category" class="form-label">Kategori</label>
                                                        <select class="form-select form-control <?= (isset($errors['category']) ? 'is-invalid' : ''); ?>" name="category" id="category">
                                                            <option value="CPNS" <?= $announcement['category'] === 'CPNS' ? 'selected' : '' ?>>CPNS</option>
                                                            <option value="PPPK" <?= $announcement['category'] === 'PPPK' ? 'selected' : '' ?>>PPPK</option>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <select class="form-select form-control <?= (isset($errors['is_active']) ? 'is-invalid' : ''); ?>" name="is_active" id="is_active">
                                                            ...
                                                            <option value="0" <?= $announcement['is_active'] === '0' ? 'selected' : '' ?>>Inactive</option>
                                                        </select>
                                                        <div class="invalid-feedback">
                                                            <?= isset($errors['category']) ? $errors['category'] : '' ?>
                                                        </div>
    ...
    <script src="<?= base_url('/assets/js/UpdateForm.js'); ?>"></script>
